...
@Metric.register("decode_span_f1")
class DecodeSpanBasedF1Measure(Metric):
    """
    ...
    def __call__(self,
        ...
        predicted_string_tags = None 
        if decode_fn is not None:
            predicted_string_tags = decode_fn(decode_args)['tags'] 
